...
/**
 * A bean consuming data from the "quote-requests" Kafka topic (mapped to "request" channel) and giving out a random quote
...
public class QuotesProcessor {
	...
	@Incoming("requests") // Indicates that the method consumes the items from requests channel
